...
export default function FloatingCallButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-electric hover:bg-electric-dark shadow-xl shadow-electric/40 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 group"
    >
