          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <AnimatedSection delay={0.15}>
              ...
              <div className="space-y-4 text-gray-500 leading-relaxed">
                <p>ProExpress was founded over 20 years ago with a single Sprinter van and one unwavering belief: in the world of logistics, speed and reliability aren\'t luxuries — they\'re necessities. What started as a small Milwaukee-based operation has grown into one of the Midwest\'s most trusted expedite carriers, serving businesses across all 48 contiguous states.</p>
